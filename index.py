...
def open_whatsapp():
    ...
    try:
        ...
        return render_template('main.html', run=True)
    except WebDriverException:
        driver.quit()
        return render_template('main.html', driver=driver)
...
def send_message():
    ...
    try:
        ...
        driver.quit()
        return render_template('index.html', run=False, error=f"{contact_name} not found in your contacts")
